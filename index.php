    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-11 col-xl-2 site-logo">
          <h1 class="mb-0"><a href="index.php" class="text-white h5 mb-0">যোগাযোগ </a></h1>
        </div>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center text-center">
        ...
        <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
          ...
          <h1 class="text-white font-weight-light text-uppercase font-weight-bold" data-aos="fade-up">Welcome to যোগাযোগ</h1>
          <p class="mb-5" data-aos="fade-up" data-aos-delay="100">Your Domestic Transportation Service Provider</p>
    ...
    <div class="container">
      <div class="row mb-5">
        ...
        <div class="col-md-6 order-md-1" data-aos="fade-up">
          ...
          <p>যোগাযোগ is a Bangladeshi domestic Transportation service provider. With the strength of an experienced and talented team, যোগাযোগ functions with the utmost confidence in the broadest coverage, security. যোগাযোগ also has a strong background in logistics management. As a result of the trust we have built with our corporate clients.</p>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-5">
          ...
          <div class="p-4 mb-3 bg-white">
            ...
            <p class="mb-4">6/w-Top Green Road</p>

            <p class="mb-0 font-weight-bold">Phone</p>
            <p class="mb-4"><a href="#">01894097578</a></p>

            <p class="mb-0 font-weight-bold">Email Address</p>
            <p class="mb-0"><a href="#">jeet.shatta@gmail.com</a></p>
