        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-md-7 text-center border-primary">
                    <h2 class="font-weight-light text-primary">Tracking</h2>
                </div>
            </div>
            <div class="row">
                        ...
                        <article class="card mt-5" style="border: 2px solid #2c3e50">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <?php if ($row['tracking_status'] == "1") { ?>
                                        <div class="col-md-3">
                                            <label for="tracking_status" class="form-label">Ride started?</label>
